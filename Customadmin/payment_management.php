...
$table_name = "" . DB_PREFIX . "_payment_details";
$current_page = "payment_management.php";
...
if (isset($_REQUEST["action"]) && $_REQUEST["action"] == "delete") {
    ...
    if ($res !== false) { // Check explicitly for `false`
        ...
        echo "<script>window.location.href = 'payment_management.php?message=Deleted Successfully!';</script>";
    }
}
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header col-xs-11">
                        ...
                        ?>
                            <h3 class="box-title">Payment Management - <?php echo ucfirst($_REQUEST["action"]); ?> </h3>
                    ...
                    ?>
                        ...
                        <div class="box-body">
                            <div class="text-right mb-3">
                                <a class="btn btn-primary" href="add_payment.php?action=add"><i class="fa fa-plus"></i> Add
                                    New</a>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-success <?php echo ($is_edit_enabled) ? "" : "disabled"; ?>"
                                                        href="add_payment.php?action=edit&id=<?php echo $row['id']; ?>"><i
                                                            class="fa fa-edit"></i> Edit</a>

                                                    <a onClick="return confirmDelete();"
                                                        href="payment_management.php?id=<?= $row['id'] ?>&action=delete"
