...
class DBManager
{
    ...
    function select_queryy($sql, $types = null, $params = null)
    {
        ...
        if ($params) {
            // 'types' is a string that defines the types of the parameters (e.g., 's' for string, 'i' for integer)
